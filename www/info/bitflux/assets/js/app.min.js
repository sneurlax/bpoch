...
!function(n,t){"object"==typeof exports&&"undefined"!=typeof module?t(exports,require("d3-request")):"function"==typeof define&&define.amd?define(["exports","d3-request"],t):t(n.fc=n.fc||{},n.d3)}(this,function(n,t){"use strict";var e=function(){var n="BTC-USD",e=null,u=null,r=null,o=function(o){var l=[];null!=e&&l.push("start="+e.toISOString()),null!=u&&l.push("end="+u.toISOString()),null!=r&&l.push("granularity="+r);var a="https://api.gdax.com/products/"+n+"/candles?"+l.join("&");t.json(a,function(n,t){return n?void o(n):(t=t.map(function(n){return{date:new Date(1e3*n[0]),open:n[3],high:n[2],low:n[1],close:n[4],volume:n[5]}}),void o(n,t))})};return o.product=function(t){return arguments.length?(n=t,o):n},o.start=function(n){return arguments.length?(e=n,o):e},o.end=function(n){return arguments.length?(u=n,o):u},o.granularity=function(n){return arguments.length?(r=n,o):r},o},u=function(){function n(n){return n[0].toLowerCase()+n.substr(1)}var e="YAHOO",u="GOOG",r=null,o=null,l=null,a=null,i=!1,s=null,c=n,f=function(n){var f=[];null!=r&&f.push("api_key="+r),null!=o&&f.push("start_date="+o.toISOString().substring(0,10)),null!=l&&f.push("end_date="+l.toISOString().substring(0,10)),null!=a&&f.push("rows="+a),i||f.push("order=asc"),null!=s&&f.push("collapse="+s);var d="https://www.quandl.com/api/v3/datasets/"+e+"/"+u+"/data.json?"+f.join("&");t.json(d,function(t,e){if(t)return void n(t);var u=e.dataset_data,r=c||function(n){return n},o=u.column_names.map(function(n,t){return[t,r(n)]}).filter(function(n){return n[1]}),l=u.data.map(function(n){var t={};return o.forEach(function(e){t[e[1]]=0===e[0]?new Date(n[e[0]]):n[e[0]]}),t});n(t,l)})};return f.database=function(n){return arguments.length?(e=n,f):e},f.dataset=function(n){return arguments.length?(u=n,f):u},f.apiKey=function(n){return arguments.length?(r=n,f):r},f.start=function(n){return arguments.length?(o=n,f):o},f.end=function(n){return arguments.length?(l=n,f):l},f.rows=function(n){return arguments.length?(a=n,f):a},f.descending=function(n){return arguments.length?(i=n,f):i},f.collapse=function(n){return arguments.length?(s=n,f):s},f.columnNameMap=function(n){return arguments.length?(c=n,f):c},f.defaultColumnNameMap=n,f};n.feedGdax=e,n.feedQuandl=u,Object.defineProperty(n,"__esModule",{value:!0})});
...
!function(a,b){"object"==typeof exports&&"undefined"!=typeof module?b(require("d3"),require("d3fc"),require("d3fc-rebind"),require("jquery"),require("d3fc-financial-feed")):"function"==typeof define&&define.amd?define(["d3","d3fc","d3fc-rebind","jquery","d3fc-financial-feed"],b):b(a.d3,a.fc,a.fc_rebind,a.$,a.fc)}(this,function(a,b,c,d,e){"use strict";function f(a,b){var c=b/2;return[[0,0],[c,-c],[a,-c],[a,c],[c,c],[0,0]]}function g(a,b){for(var c=a.ticks.apply(a,[]),d=a.domain(),e=0;e<b.length;e++)b[e]>d[0]&&b[e]<d[1]&&c.push(b[e]);return c}function h(a){return a.reduce(function(a,b){return b.extentAccessor?a.concat(b.extentAccessor):a},[])}function i(a,b,c,d){return{interval:a,step:b,duration:c,format:d}}a="default"in a?a["default"]:a,b="default"in b?b["default"]:b,c="default"in c?c["default"]:c,d="default"in d?d["default"]:d;var j={crosshairChange:"crosshairChange",viewChange:"viewChange",newTrade:"newTrade",historicDataLoaded:"historicDataLoaded",historicFeedError:"historicFeedError",streamingFeedError:"streamingFeedError",streamingFeedClose:"streamingFeedClose",dataProductChange:"dataProductChange",dataPeriodChange:"dataPeriodChange",resetToLatest:"resetToLatest",clearAllPrimaryChartIndicatorsAndSecondaryCharts:"clearAllPrimaryChartIndicatorsAndSecondaryCharts",primaryChartSeriesChange:"primaryChartSeriesChange",primaryChartYValueAccessorChange:"primaryChartYValueAccessorChange",primaryChartIndicatorChange:"primaryChartIndicatorChange",secondaryChartChange:"secondaryChartChange",indicatorChange:"indicatorChange",notificationClose:"notificationClose"},k=function(){function c(b){b.each(function(b){var c=a.select(this),g=c.select("#tooltip");d=b.product.priceFormat,e=b.product.volumeFormat,f=b.period.timeFormat,c.classed("hidden",!b.data),g.layout({flexDirection:"row"}).selectAll(".tooltip").layout({marginRight:40,marginLeft:15}),b.data&&g.datum(b.data).call(h)})}var d,e,f,g="0.71em",h=b.chart.tooltip().items([["T",function(a){return f(a.date)}],["O",function(a){return d(a.open)}],["H",function(a){return d(a.high)}],["L",function(a){return d(a.low)}],["C",function(a){return d(a.close)}],["V",function(a){return e(a.volume)}]]).decorate(function(a){a.enter().selectAll("text").attr("dy",g)});return c},l=function(a,c,d,e){var f=b.util.extent().fields(["date"])(d),g=b.util.extent().fields([b.util.fn.identity])(c),h=a.distance(g[0],g[1]);if(e.getTime()<f[0]||e.getTime()>f[1])return g;var i=[a.offset(e,-h/2),a.offset(e,h/2)],j=0;return i[1].getTime()>f[1].getTime()?j=-a.distance(f[1],i[1]):i[0].getTime()<f[0].getTime()&&(j=a.distance(i[0],f[0])),[a.offset(i[0],j),a.offset(i[1],j)]},m=function(b,c){var d=a.min(b,function(a){return a.getTime()}),e=a.max(b,function(a){return a.getTime()}),f=c.sort(function(a,b){return a.date-b.date}),g=a.bisector(function(a){return a.date}),h=c.slice(
// Pad and clamp the bisector values to ensure extents can be calculated
Math.max(0,g.left(f,d)-1),Math.min(g.right(f,e)+1,f.length));return h},n=function(a,c,d,e){arguments.length<4&&(e=1);
// Ensure the earlier data is first in the array
var f=b.util.extent().fields([b.util.fn.identity])(c),g=b.util.extent().fields([b.util.fn.identity])(d),h=a.distance(g[0],g[1]),i=e*a.distance(f[0],f[1]),j=i<h?[a.offset(g[1],-i),g[1]]:g;return j},o=function(b,c){var d=a.max(b,function(a){return a.getTime()}),e=a.max(c,function(a){return a.date.getTime()});return d===e},p={centerOnDate:l,filterDataInDateRange:m,moveToLatest:n,trackingLatestData:o},q=!1,r=function(a,c){a.secondaries.style("flex",c.secondaries().charts().length),a.overlaySecondaries.style("flex",c.secondaries().charts().length);var d=parseInt(a.app.select(".head-row").style("height"),10);q||(d+=parseInt(a.app.select(".head-row").style("padding-top"),10)+parseInt(a.app.select(".head-row").style("padding-bottom"),10)+parseInt(a.app.select(".head-row").style("margin-bottom"),10),q=!0);var e=b.util.innerDimensions(a.app.node()).height-d;a.chartsAndOverlay.style("height",e+"px"),c.xAxis().dimensionChanged(a.xAxis),c.nav().dimensionChanged(a.navbar),c.primary().dimensionChanged(a.primary),c.secondaries().charts().forEach(function(b){b.option.dimensionChanged(a.secondaries)})},s=0,t=function(){return++s},u=function(a){return d(a).width()},v=function(a,b,c){var d,e,f,g,h=function(){var i=(new Date).getTime()-f;i<b&&i>=0?d=setTimeout(h.bind(this),b-i):(d=null,c||(g=a.apply(this,e),e=null))};return function(){e=arguments,f=(new Date).getTime();var i=c&&!d;return d||(d=setTimeout(h.bind(this),b)),i&&(g=a.apply(this,e),e=null),g}},w=function(a,b,c){var d,e,f=null,g=0;c||(c={});var h=function(){g=c.leading===!1?0:(new Date).getTime(),f=null,e=a.apply(this,d),f||(d=null)};return function(){var i=(new Date).getTime();g||c.leading!==!1||(g=i);var j=b-(i-g);return d=arguments,j<=0||j>b?(f&&(clearTimeout(f),f=null),g=i,e=a.apply(this,d),f||(d=null)):f||c.trailing===!1||(f=setTimeout(h.bind(this),j)),e}},x={domain:p,layout:r,uid:t,width:u,debounce:v,throttle:w},y=function(b){function c(a){
// If zooming, and about to pan off screen, do nothing
return a[0]>0&&a[1]<0}function d(){l.translate([0,0]),l.scale(1)}function e(a,b,c){return Math.min(Math.max(a,b),c)}function f(b,c){var d=b;return h(j[0])>0&&(d[1]=h.invert(h(b[1])+h(j[0]))),d[0]=a.max([c[0],d[0]]),d[1]=a.min([c[1],d[1]]),d}function g(g){var p=h(j[0]),q=h(j[1]),r=[p,q-b];l.x(h).on("zoom",function(){var b=a.event.translate,g=b[0],p=c(r);g=e(g,-r[1],-r[0]),l.translate([g,0]);var q=1===l.scale(),s=1!==l.scale();if(q&&m||s&&n){var t=h.domain();p?t=j:s&&o&&(t=x.domain.moveToLatest(i,t,j)),t=f(t,j),t[0].getTime()!==t[1].getTime()?k.zoom(t):
// Ensure the user can't zoom-in infinitely, causing the chart to fail to render
// #168, #411
d()}else d()}),g.call(l).on("dblclick.zoom",null)}var h,i,j,k=a.dispatch("zoom"),l=a.behavior.zoom(),m=!0,n=!0,o=!0;return g.allowPan=function(a){return arguments.length?(m=a,g):m},g.allowZoom=function(a){return arguments.length?(n=a,g):n},g.trackingLatest=function(a){return arguments.length?(o=a,g):o},g.scale=function(a){return arguments.length?(h=a,g):h},g.discontinuityProvider=function(a){return arguments.length?(i=a,g):i},g.dataDateExtent=function(a){return arguments.length?(j=a,g):j},a.rebind(g,k,"on"),g},z=function(a,b,c){return arguments.length<3&&(c=1),Math.max(Math.ceil(a/b),c)},A=function(){function c(a,b){a.select(".plot-area").selectAll(".e, .w").classed("hidden",b)}function d(a){return a.extent()[0]-a.extent()[1]===0}function e(a,c){var d=a.selectAll("defs").data([0]).enter().append("defs");d.html('<linearGradient id="brush-gradient" x1="0" x2="0" y1="0" y2="1">               <stop offset="0%" class="brush-gradient-top" />               <stop offset="100%" class="brush-gradient-bottom" />           </linearGradient>           <mask id="brush-mask">               <rect class="mask-background"></rect>           </mask>'),a.select(".mask-background").attr({width:g,height:k}),t.domain(b.util.extent().fields(["date"])(c)),u.domain(b.util.extent().fields(["low","high"]).pad(q)(c)),a.select("mask").datum(c).call(H)}function f(a){var f=a.datum();G.bucketSize(Math.max(f.data.length/r,1));var h=G(f.data);t.discontinuityProvider(f.discontinuityProvider),w.discontinuityProvider(f.discontinuityProvider),e(a,h),w.domain(f.viewDomain);var i=x.domain.filterDataInDateRange(b.util.extent().fields(["date"])(h),h),k=b.util.extent().fields(["low","high"]).pad(q)(i);v.xDomain(b.util.extent().fields(["date"])(h)).yDomain(k).xTicks(z(g,100,2)),C.on("brush",function(){var b=d(C);
// Hide the bar if the extent is empty
c(a,b),b||s[j.viewChange](C.extent())}).on("brushend",function(){var b=d(C);c(a,!1),b&&s[j.viewChange](x.domain.centerOnDate(f.discontinuityProvider,w.domain(),f.data,C.extent()[0]))}),v.plotArea(D),a.datum({data:h}).call(v);
// Allow to zoom using mouse, but disable panning
var l=y(g).scale(w).trackingLatest(f.trackingLatest).discontinuityProvider(f.discontinuityProvider).dataDateExtent(b.util.extent().fields(["date"])(f.data)).allowPan(!1).on("zoom",function(a){s[j.viewChange](a)});a.select(".plot-area").call(l)}var g,h=100,i=40,k=h-i,l=1,m=k-l,n=m,o=l+n/2,p=2,q=[0,.04],r=200,s=a.dispatch(j.viewChange),t=b.scale.dateTime(),u=a.scale.linear(),v=b.chart.cartesian(t,u).yTicks(0).margin({bottom:i}).xOuterTickSize(0).yOuterTickSize(0),w=b.scale.dateTime(),A=b.series.area().xValue(function(a){return a.date}).y1Value(function(a){return a.close}).y0Value(function(){return u.domain()[0]}),B=b.series.line().xValue(function(a){return a.date}).yValue(function(a){return a.close}),C=a.svg.brush(),D=b.series.multi().series([A,B,C]).decorate(function(a){var b=a.enter();a.selectAll(".background, .extent").attr("height",m).attr("y",l),
// overload d3 styling for the brush handles
// as Firefox does not react properly to setting these through less file.
b.selectAll(".resize.w>rect, .resize.e>rect").attr("width",p).attr("x",-p/2),a.selectAll(".resize.w>rect, .resize.e>rect").attr("height",n).attr("y",l),b.select(".extent").attr("mask",'url("#brush-mask")');
// Adds the handles to the brush sides
var c=b.selectAll(".e, .w");c.append("circle").attr("cy",o).attr("r",7).attr("class","outer-handle"),c.append("circle").attr("cy",o).attr("r",4).attr("class","inner-handle")}).mapping(function(a){return a===C?(C.y(null).extent(w.domain()),null):this.data}),E=b.series.area().xValue(function(a){return a.date}).y1Value(function(a){return a.close}).y0Value(function(){return u.domain()[0]}).decorate(function(a){a.enter().attr("fill",'url("#brush-gradient")')}),F=b.series.line().xValue(function(a){return a.date}).yValue(function(a){return a.close}),G=b.data.sampler.largestTriangleThreeBucket().x(function(a){return t(a.date)}).y(function(a){return u(a.close)}),H=b.series.multi().series([E,F]).xScale(t).yScale(u);return a.rebind(f,s,"on"),f.dimensionChanged=function(a){g=x.width(a.node()),w.range([0,g]),t.range([0,g]),u.range([k,0])},f},B=function(){function c(){var a=[v,n.option,w],b=s.map(function(a){return a.option});return a.concat(b,u)}function d(){switch(D.value(r),E.value(r),w.value(r),n.valueString){case"line":case"point":n.option.yValue(r);break;case"area":n.option.yValue(r),n.option.y0Value(function(){return B.domain()[0]})}}
// Call when what to display on the chart is modified (ie series, options)
function e(a){n=a.series,r=a.yValueAccessor.option,s=a.indicators,d(),z.series(c()),C.yTickFormat(a.product.priceFormat),a.selectorsChanged=!1}function i(a){var b=n.option.width(a);u.decorate(function(a){a.classed("band",!0),a.selectAll(".vertical > line").style("stroke-width",b)})}function k(a){a.classed("band",!1).selectAll("line").style("stroke-width",null)}function l(a){"candlestick"===n.valueString||"ohlc"===n.valueString?i(a):u.decorate(k)}function m(c){var d=c.datum();d.selectorsChanged&&e(d),C.xDomain(d.viewDomain),A.discontinuityProvider(d.discontinuityProvider),u.snap(b.util.seriesPointSnapXOnly(n.option,d.visibleData)),l(d.visibleData),D(d.data),E(d.data);
// Scale y axis
// Add percentage padding either side of extreme high/lows
var i=h(z.series()),k=b.util.extent().fields(i).pad(.08)(d.visibleData);C.yDomain(k);
// Find current tick values and add close price to this list, then set it explicitly below
var m=r(d.data[d.data.length-1]),s=g(B,[m]);C.yTickValues(s).yDecorate(function(b){var c=b.filter(function(a){return a===m}).classed("close-line",!0),d=18;c.select("path").attr("d",function(){return a.svg.area()(f(p,d))}),c.select("text").attr("transform","translate("+d/2+",1)")});var t=B.ticks.apply(B,[]);v.yTickValues(t),
// Redraw
C.plotArea(z),c.call(C);var w=y(o).scale(A).trackingLatest(d.trackingLatest).discontinuityProvider(d.discontinuityProvider).dataDateExtent(b.util.extent().fields(["date"])(d.data)).on("zoom",function(a){q[j.viewChange](a)});c.select(".plot-area").call(w)}var n,o,p=60,q=a.dispatch(j.viewChange,j.crosshairChange),r=function(a){return a.close},s=[],t=[],u=b.tool.crosshair().xLabel("").yLabel("").on("trackingmove",function(a){a.length>0?q.crosshairChange(a[0].datum):q.crosshairChange(void 0)}).on("trackingend",function(){q.crosshairChange(void 0)});u.id=x.uid();var v=b.annotation.gridline().xTicks(0),w=b.annotation.line().orient("horizontal").value(r).label("").decorate(function(a){a.classed("close-line",!0)});w.id=x.uid();var z=b.series.multi().key(function(a){return a.id}).mapping(function(a){switch(a){case w:return[this.data[this.data.length-1]];case u:return t;default:return this.visibleData}}).decorate(function(a){a.enter().select(".area").attr("fill",'url("#primary-area-series-gradient")')}),A=b.scale.dateTime(),B=a.scale.linear(),C=b.chart.cartesian(A,B).xTicks(0).yOrient("right").margin({top:0,left:0,bottom:0,right:p}).decorate(function(a){a.enter().selectAll("defs").data([0]).enter().append("defs").html('<linearGradient id="primary-area-series-gradient" x1="0%" x2="0%" y1="0%" y2="100%">                       <stop offset="0%" class="primary-area-series-gradient-top" />                       <stop offset="100%" class="primary-area-series-gradient-bottom" />                   </linearGradient>')}),D=b.indicator.algorithm.movingAverage(),E=b.indicator.algorithm.bollingerBands();
// Call when the main layout is modified
return a.rebind(m,q,"on"),m.dimensionChanged=function(a){o=x.width(a.node())-p},m},C=function(){function c(a){return a.option.id}function d(b){b.each(function(b){var c=g(this,e);c.each(function(c){this.__secondaryChart__=c,c.option.on(j.viewChange,f[j.viewChange]),a.select(this).datum(b).call(c.option)})})}var e=[],f=a.dispatch(j.viewChange),g=b.util.dataJoin().children(!0).selector(".secondary-container").element("svg").attr("class",function(a){return"secondary-container secondary-"+a.valueString}).key(function(a){
...
return c(this.__secondaryChart__||a)});return d.charts=function(a){return arguments.length?(e=a,d):e},a.rebind(d,f,"on"),d},D=1e3,E=60*D,F=60*E,G=24*F,H=7*G,I=30*G,J=365*G,K=[[a.time.second,1,D,"%H:%M,%d %b"],[a.time.second,5,5*D,"%H:%M,%d %b"],[a.time.second,15,15*D,"%H:%M,%d %b"],[a.time.second,30,30*D,"%H:%M,%d %b"],[a.time.minute,1,E,"%H:%M,%d %b"],[a.time.minute,5,5*E,"%H:%M,%d %b"],[a.time.minute,15,15*E,"%H:%M,%d %b"],[a.time.minute,30,30*E,"%H:%M,%d %b"],[a.time.hour,1,F,"%H:%M,%d %b"],[a.time.hour,3,3*F,"%H:%M,%d %b"],[a.time.hour,6,6*F,"%H:%M,%d %b"],[a.time.hour,12,12*F,"%H:%M,%d %b"],[a.time.day,1,G,"%a %d,%b %Y"],[a.time.week,1,H,"%d %b,%Y"],[a.time.month,1,I,"%B,%Y"],[a.time.month,3,3*I,"%B,%Y"],[a.time.year,1,J,"%Y"]].map(function(a){return i.apply(this,a)}),L=function(){function b(a){return k.distance(a[0],a[1])}function c(a){var b=a[0],c=a[a.length-1];return b<c?[b,c]:[c,b]}function d(b,d){var e=c(b.map(function(a){return a/J})),f=e[1]-e[0],g=Math.pow(10,Math.floor(Math.log(f/d)/Math.LN10)),h=d/f*g;return h<=.15?g*=10:h<=.35?g*=5:h<=.75&&(g*=2),i(a.time.year,g,g*J,"%Y")}function e(){var a=-1;return null!=j&&2===j.length&&K.forEach(function(b,c){b.interval===j[0]&&b.step===j[1]&&(a=c)}),a}function f(c,f){var g,h=b(c),i=h/f,j=a.bisector(function(a){return a.duration}).right(K,i);if(j===K.length){g=d(c,f);for(
...
var k=f;h/g.duration>f&&k>=2&&f>0;)k-=1,g=d(c,k)}else{for(var l=j>0&&i/K[j-1].duration<K[j].duration/i?j-1:j;h/K[l].duration>f&&l<K.length-1;)l+=1;g=K[Math.max(l,e())]}return g}function g(){if(null!=j&&e()===-1)throw new Error("Specified minimum tick interval is not supported");var a=c(h),b=f(a,null===l?10:l),d=b.interval,g=b.step,i=d.range(a[0],new Date(+a[1]+1),Math.max(1,g));// inclusive upper bound
return i.method=[d,g],i.format=b.format,i}var h,j,k,l=10;return g.domain=function(a){return arguments.length?(h=a,g):h},g.ticks=function(a){return arguments.length?(l=a,g):l},g.minimumTickInterval=function(a){return arguments.length?(j=a,g):j},g.discontinuityProvider=function(a){return arguments.length?(k=a,g):k},g},M=function(){function c(c){var g=c.datum();d.domain(g.viewDomain).discontinuityProvider(g.discontinuityProvider);var h=2,i=100,j=z(d.range()[1],i,h),k=g.period,l=e.domain(d.domain()).discontinuityProvider(g.discontinuityProvider).ticks(j).minimumTickInterval([k.d3TimeInterval.unit,k.d3TimeInterval.value])();f.tickValues(b.scale.dateTime.tickTransformer(l,g.discontinuityProvider,g.viewDomain)).tickFormat(a.time.format(l.format)),c.call(f)}var d=b.scale.dateTime(),e=L(),f=b.svg.axis().scale(d).orient("bottom").decorate(function(b){b.selectAll("text").each(function(){var b=a.select(this),c=b.text().split(",");b.text(null),b.append("tspan").attr("class","axis-label-main").attr("x",0).text(c[0]),b.append("tspan").attr("class","axis-label-secondary").attr("dy","1.42em").attr("x",0).text(c[1])})});return c.dimensionChanged=function(a){d.range([0,x.width(a.node())])},c},N=function(){function b(a){a.each(function(b){a.select("#legend").datum(b.legend).call(d),a.select("#navbar-container").datum(b.nav).call(e),a.select("#primary-container").datum(b.primary).call(f),a.select("#secondaries-container").datum(b.secondary).call(g),a.select("#x-axis-container").datum(b.xAxis).call(h)})}var c=a.dispatch(j.viewChange,j.crosshairChange),d=k(),e=A().on(j.viewChange,c[j.viewChange]),f=B().on(j.viewChange,c[j.viewChange]).on(j.crosshairChange,c[j.crosshairChange]),g=C().on(j.viewChange,c[j.viewChange]),h=M();return b.legend=function(){return d},b.nav=function(){return e},b.primary=function(){return f},b.secondaries=function(){return g},b.xAxis=function(){return h},a.rebind(b,c,"on"),b},O=function(a){return{displayString:a.display,option:a}},P=function(a){return{displayString:a.display,option:a}},Q=function(){function c(a){var b=a.datum(),c=b.selectedIndex||0,i=b.config,j=e(a,[b.options]);if(i.icon){var k=j.selectAll(".icon").data([0]);k.enter().append("span"),k.attr("class","icon "+b.options[c].icon)}else j.select(".icon").remove(),j.text(function(){return i.title||b.options[c].displayString});f(j,i.careted?[0]:[]);var l=g(a,[b.options]),m=h(l,b.options),n=m.enter().on("click",d.optionChange).append("a").attr("href","#");n.append("span").attr("class","icon"),n.append("span").attr("class","name"),m.classed("selected",function(a,d){return b.selectedIndexes?b.selectedIndexes.indexOf(d)>-1:d===c}),m.selectAll(".icon").attr("class",function(a){return"icon "+a.icon}),m.selectAll(".name").text(function(a){return a.displayString})}var d=a.dispatch("optionChange"),e=b.util.dataJoin().selector("button").element("button").attr({"class":"dropdown-toggle",type:"button","data-toggle":"dropdown"}),f=b.util.dataJoin().selector(".caret").element("span").attr("class","caret"),g=b.util.dataJoin().selector("ul").element("ul").attr("class","dropdown-menu"),h=b.util.dataJoin().selector("li").element("li").key(function(a){return a.displayString});return a.rebind(c,d,"on"),c},R=function(){function c(a){var c=a.datum().selectedIndex||0,f=e(a,[a.datum().options]);f.enter().append("ul");var g=f.selectAll("li").data(b.util.fn.identity);g.enter().append("li").append("a").attr("href","#").on("click",d.tabClick),g.classed("active",function(a,b){return b===c}).select("a").text(function(a){return a.displayString}),g.exit().remove()}var d=a.dispatch("tabClick"),e=b.util.dataJoin().selector("ul").element("ul");return a.rebind(c,d,"on"),c},S=function(){var b=a.dispatch(j.dataProductChange,j.dataPeriodChange,j.clearAllPrimaryChartIndicatorsAndSecondaryCharts),c=Q().on("optionChange",b[j.dataProductChange]),d=R().on("tabClick",b[j.dataPeriodChange]),e=Q().on("optionChange",b[j.dataPeriodChange]),f=function(f){f.each(function(f){var g=a.select(this),h=f.products;g.select("#product-dropdown").datum({config:f.productConfig,options:h.map(O),selectedIndex:h.map(function(a){return a.id}).indexOf(f.selectedProduct.id)}).call(c);var i=f.selectedProduct.periods;g.select("#period-selector").classed("hidden",i.length<=1).datum({options:i.map(P),selectedIndex:i.indexOf(f.selectedPeriod)}).call(d),g.select("#mobile-period-selector").classed("hidden",i.length<=1).datum({config:f.mobilePeriodConfig,options:i.map(P),selectedIndex:i.indexOf(f.selectedPeriod)}).call(e),g.select("#clear-indicators").on("click",b[j.clearAllPrimaryChartIndicatorsAndSecondaryCharts])})};return a.rebind(f,b,"on"),f},T=function(){var b=a.dispatch(j.primaryChartSeriesChange,j.primaryChartIndicatorChange,j.secondaryChartChange),c=Q().on("optionChange",b[j.primaryChartSeriesChange]),d=Q().on("optionChange",function(a){a.isPrimary?b[j.primaryChartIndicatorChange](a):b[j.secondaryChartChange](a)}),e=function(b){b.each(function(b){var e=a.select(this),f=b.seriesSelector.options.map(function(a){return a.isSelected}).indexOf(!0);e.select(".series-dropdown").datum({config:b.seriesSelector.config,options:b.seriesSelector.options,selectedIndex:f}).call(c);var g=b.indicatorSelector.options,h=g.reduce(function(a,b,c){return b.isSelected?a.concat(c):a},[]);e.select(".indicator-dropdown").datum({config:b.indicatorSelector.config,options:g,selectedIndexes:h}).call(d)})};return a.rebind(e,b,"on"),e},U=function(){function b(a){var b=a.datum(),d=a.selectAll("g").data([b]),e=d.enter().append("g").attr("class","reset-button").on("click",c[j.resetToLatest]);e.append("path").attr("d","M1.5 1.5h13.438L23 20.218 14.937 38H1.5l9.406-17.782L1.5 1.5z"),e.append("rect").attr({width:5,height:28,x:26,y:6}),d.classed("hidden",b.trackingLatest)}var c=a.dispatch(j.resetToLatest);return a.rebind(b,c,"on"),b},V=function(){function b(b){b.each(function(b){var d=a.select(this),e=d.selectAll("div").data(b.selectedIndicators,function(a){return a.valueString}),f=e.enter().append("div").attr("class","edit-indicator");f.append("span").attr("class","icon bf-icon-delete").on("click",c.indicatorChange),f.append("span").attr("class","indicator-label").text(function(a){return a.displayString}),e.exit().remove()})}var c=a.dispatch(j.indicatorChange);return a.rebind(b,c,"on"),b},W=function(){var c=a.dispatch(j.primaryChartIndicatorChange,j.secondaryChartChange,j.dataProductChange),d=V().on(j.indicatorChange,c[j.primaryChartIndicatorChange]),e=V().on(j.indicatorChange,c[j.secondaryChartChange]),f=Q().on("optionChange",c[j.dataProductChange]),g=b.util.dataJoin().selector(".overlay-secondary-container").element("div").attr("class","overlay-secondary-container").key(function(a){return a.displayString}),h=function(b){b.each(function(b){var c=a.select(this),h=b.products;c.select("#mobile-product-dropdown").datum({config:b.productConfig,options:h.map(O),selectedIndex:h.map(function(a){return a.id}).indexOf(b.selectedProduct.id)}).call(f),c.select("#overlay-primary-container .edit-indicator-container").datum({selectedIndicators:b.primaryIndicators}).call(d);var i=c.select("#overlay-secondaries-container"),j=g(i,b.secondaryIndicators),k=j.enter().append("div").attr("class","edit-indicator-container");k.each(function(b){a.select(this).datum({selectedIndicators:[b]}).call(e)})})};return a.rebind(h,c,"on"),h},X={head:S,selectors:T,navigationReset:U,overlay:W},Y=function(){function a(a){var c=++b;return function(d,e){c<b||a(d,e)}}var b=0;return a.invalidateCallback=function(){return b++,a},a},Z=function(){function b(a){var b=1e3*f;return new Date(Math.floor(a.getTime()/b)*b)}var c=function(a){return a.date},d=function(a){return Number(a.volume)},e=function(a){return Number(a.price)},f=60,g=function(f,g){var h=b(c(g)),i=e(g),j=d(g),k=a.bisector(function(a){return a.date}).left,l=f.filter(function(a){return a.date.getTime()===h.getTime()})[0];l?(l.high=Math.max(i,l.high),l.low=Math.min(i,l.low),l.close=i,l.volume+=j):f.splice(k(f,h),0,{date:h,open:i,high:i,low:i,close:i,volume:j})};return g.granularity=function(a){return arguments.length?(f=a,g):f},g.price=function(a){return arguments.length?(e=a,g):e},g.volume=function(a){return arguments.length?(d=a,g):d},g.date=function(a){return arguments.length?(c=a,g):c},g},$=function(){function b(){f&&f.streamingFeed&&f.streamingFeed.close(),l=[],i.invalidateCallback()}function c(a){return a.sort(function(a,b){return a.date-b.date})}function d(){null!=f.streamingFeed&&(f.streamingFeed.on("message",function(a){h(l,a),g[j.newTrade](l,f)}).on("error",function(a){g[j.streamingFeedError](a,f)}).on("close",function(a){g[j.streamingFeedClose](a,f)}),f.streamingFeed())}function e(a,e){b(),2===arguments.length&&(f=e.source,f.historicFeed.product(e.id),null!=f.streamingFeed&&f.streamingFeed.product(e.id));var m=new Date;f.historicFeed.end(m).candles(k).granularity(a),h.granularity(a),f.historicFeed(i(function(a,b){a?g[j.historicFeedError](a,f):(l=c(b),g[j.historicDataLoaded](l,f),d())}))}var f,g=a.dispatch(j.newTrade,j.historicDataLoaded,j.historicFeedError,j.streamingFeedError,j.streamingFeedClose),h=Z().date(function(a){return new Date(a.time)}).volume(function(a){return Number(a.size)}),i=Y(),k=200,l=[];return e.candlesOfData=function(a){return arguments.length?(k=a,e):k},a.rebind(e,g,"on"),e},_=function(){var c=a.dispatch(j.notificationClose),d=b.util.dataJoin().selector("div.alert-content").element("div").attr("class","alert-content"),e=b.util.dataJoin().selector("div.alert").element("div").attr({"class":"alert alert-info alert-dismissible",role:"alert"}).key(function(a){return a.id}),f=function(b){b.each(function(b){var f=a.select(this),g=d(f,[b]);g.enter().html('<div class="messages"></div>');var h=e(g.select(".messages"),b.messages),i=h.enter();i.html('<button type="button" class="close" aria-label="Close">                     <span aria-hidden="true">&times;</span>                 </button>                 <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span>                 <span class="sr-only">Error:</span>                 <span class="message"></span>'),i.select(".close").on("click",function(a){c[j.notificationClose](a.id)}),h.select(".message").text(function(a){return a.message})})};return a.rebind(f,c,"on"),f},aa={toast:_},ba=function(a){return{id:x.uid(),message:a}},ca=function(b,c,d,e){return{display:b||"1 day",seconds:c||86400,d3TimeInterval:d||{unit:a.time.day,value:1},timeFormat:a.time.format(e||"%b %d")}},da=function(b,c,d,e,f,g){return{id:b,display:c||"Unspecified Product",priceFormat:a.format(g||".2f"),volumeFormat:a.format(f||".2f"),periods:d||[],source:e}},ea=function(a,b,c,d,e){return{historicFeed:a,historicNotificationFormatter:b,streamingFeed:c,streamingNotificationFormatter:d,discontinuityProvider:e}},fa={period:ca,product:da,source:ea},ga=function(a){var b;if(a.wasClean===!1&&1e3!==a.code&&1006!==a.code){var c=a.reason||"Unkown reason.";b="Disconnected from live stream: "+a.code+" "+c}return b},ha=function(a){var b;
// The WebSocket's error event doesn't contain much useful information,
// so the close event is used to report errors instead
return"error"===a.type&&a.message?b="Live stream error: "+a.message:"close"===a.type&&(b=ga(a)),b},ia=function(a,b,c,d){return{title:a||null,careted:b||!1,listIcons:c||!1,icon:d||!1}},ja=function(a,b,c){return{productConfig:ia(null,!0),mobilePeriodConfig:ia(),products:a,selectedProduct:b,selectedPeriod:c,alertMessages:[],primaryIndicators:[],secondaryIndicators:[]}},ka=function(a,b){return{primaryIndicators:[],secondaryIndicators:[],productConfig:ia(),products:a,selectedProduct:b}},la=function(a,b,c,d,e){return{displayString:a,// TODO: is 'displayName' better?
valueString:b,// TODO: is this an id?
option:c,// TODO: Ideally, remove.
isSelected:!1,icon:d,isPrimary:e}},ma=function(a,b){return{config:a,options:b}},na={head:ja,periodAdaptor:P,productAdaptor:O,overlay:ka,dropdownConfig:ia,option:la,selector:ma},oa=function(a,b,c,d,e){return{legend:a,nav:b,primary:c,secondary:d,xAxis:e}},pa=function(a,b){return{data:void 0,product:a,period:b}},qa=function(a){return{data:[],viewDomain:[],trackingLatest:!0,discontinuityProvider:a}},ra=function(){return{trackingLatest:!0}},sa=function(){var c=b.scale.dateTime(),d=a.scale.linear(),e=b.util.fractionalBarWidth(.75),f=function(a){return a.date},g=function(a,b){return c(f(a,b))},h=function(a){return a.low},i=function(a){return a.high},j=function(a){return a.close},k=b.svg.candlestick().x(function(a){return c(a.date)}).open(function(a){return d(a.open)}).high(function(a){return d(i(a))}).low(function(a){return d(h(a))}).close(function(a){return d(a.close)}),l=b.util.dataJoin().selector("path.up").element("path").attr("class","up"),m=b.util.dataJoin().selector("path.down").element("path").attr("class","down"),n=function(a){a.each(function(a){k.width(e(a.map(g)));var b=a.filter(function(a){return a.open<a.close}),c=a.filter(function(a){return a.open>=a.close});l(this,[b]).attr("d",k),m(this,[c]).attr("d",k)})};return n.xScale=function(a){return arguments.length?(c=a,n):c},n.yScale=function(a){return arguments.length?(d=a,n):d},n.xValue=function(a){return arguments.length?(f=a,n):f},n.yLowValue=function(a){return arguments.length?(h=a,n):h},n.yHighValue=function(a){return arguments.length?(i=a,n):i},n.yCloseValue=function(a){return arguments.length?(j=a,n):j},n.width=function(a){return e(a.map(g))},n},ta=function(a,b){var c={data:[],visibleData:[],trackingLatest:!0,viewDomain:[],selectorsChanged:!0,discontinuityProvider:b},d=a;Object.defineProperty(c,"product",{get:function(){return d},set:function(a){d=a,c.selectorsChanged=!0}});var e=sa();e.id=x.uid();var f=la("Candlestick","candlestick",e);f.option.extentAccessor=["high","low"],Object.defineProperty(c,"series",{get:function(){return f},set:function(a){f=a,c.selectorsChanged=!0}});var g={option:function(a){return a.close}};Object.defineProperty(c,"yValueAccessor",{get:function(){return g},set:function(a){g=a,c.selectorsChanged=!0}});var h=[];return Object.defineProperty(c,"indicators",{get:function(){return h},set:function(a){h=a,c.selectorsChanged=!0}}),c},ua=function(a,b){return{data:[],visibleData:[],viewDomain:[],trackingLatest:!0,product:a,discontinuityProvider:b,indicators:[]}},va=function(a,b){return{viewDomain:[],period:a,discontinuityProvider:b}},wa={group:oa,legend:pa,nav:qa,navigationReset:ra,primary:ta,secondary:ua,xAxis:va},xa=function(){return{messages:[]}},ya={message:ba,messages:xa},za={menu:na,chart:wa,data:fa,notification:ya},Aa=function(){function c(c){c.each(function(c){f.discontinuityProvider(c.discontinuityProvider);var g=a.select(this).datum(c.visibleData).call(l),i=y(d).scale(f).trackingLatest(h).discontinuityProvider(c.discontinuityProvider).dataDateExtent(b.util.extent().fields(["date"])(c.data)).on("zoom",function(a){e[j.viewChange](a)});g.select(".plot-area-container").call(i)})}var d,e=a.dispatch(j.viewChange),f=b.scale.dateTime(),g=a.scale.linear(),h=!0,i=60,k=b.series.multi(),l=b.chart.cartesian(f,g).plotArea(k).xTicks(0).yOrient("right").margin({top:0,left:0,bottom:0,right:i});return c.trackingLatest=function(a){return arguments.length?(h=a,c):h},a.rebind(c,e,"on"),a.rebind(c,k,"series","mapping","decorate"),a.rebind(c,l,"yTickValues","yTickFormat","yTicks","xDomain","yDomain"),c.dimensionChanged=function(a){d=x.width(a.node())-i},c},Ba=function(){function c(a){var c=a.datum();g(c.data);var d=b.util.extent().fields(["macd"]).symmetricalAbout(0).pad(.08)(c.data.map(function(a){return a.macd}));h.trackingLatest(c.trackingLatest).xDomain(c.viewDomain).yDomain(d),a.call(h)}var d=a.dispatch(j.viewChange),e=b.annotation.line().value(0).label(""),f=b.indicator.renderer.macd(),g=b.indicator.algorithm.macd(),h=Aa().series([e,f]).yTicks(5).mapping(function(a){return a===e?[0]:this}).decorate(function(a){a.enter().attr("class",function(a,b){return["multi zero","multi"][b]})}).on(j.viewChange,function(a){d[j.viewChange](a)});return a.rebind(c,d,"on"),c.dimensionChanged=function(a){h.dimensionChanged(a)},c},Ca=function(){function c(a){var b=a.datum();f(b.data),h.trackingLatest(b.trackingLatest).xDomain(b.viewDomain).yDomain([0,100]),a.call(h)}var d=a.dispatch(j.viewChange),e=b.indicator.renderer.relativeStrengthIndex(),f=b.indicator.algorithm.relativeStrengthIndex().value(function(a){return a.close}),g=[e.lowerValue(),50,e.upperValue()],h=Aa().series([e]).yTickValues(g).on(j.viewChange,function(a){d[j.viewChange](a)});return a.rebind(c,d,"on"),c.dimensionChanged=function(a){h.dimensionChanged(a)},c},Da=function(){function c(a){a.each(function(c){var d=b.util.extent().fields(["volume"]).pad(.08)(c.data);d[0]<0&&(d[0]=0),f.yTickFormat(c.product.volumeFormat).trackingLatest(c.trackingLatest).xDomain(c.viewDomain).yDomain(d),a.call(f)})}var d=a.dispatch(j.viewChange),e=b.series.bar().xValue(function(a){return a.date}).yValue(function(a){return a.volume}),f=Aa().series([e]).yTicks(4).on(j.viewChange,function(a){d[j.viewChange](a)});return a.rebind(c,d,"on"),c.dimensionChanged=function(a){f.dimensionChanged(a)},c},Ea={base:Aa,macd:Ba,rsi:Ca,volume:Da},Fa={legend:k,nav:A,primary:B,xAxis:M,secondary:Ea,multiChart:C,group:N},Ga=function(){var c,d,e,f=b.data.random.financial(),g=[86400],h=null,i=function(b){d.setHours(0,0,0,0);var e=a.time.day.offset(d,-(c-1));f.startDate(e);var g=f(c);b(null,g)};return i.candles=function(a){return arguments.length?(c=a,i):c},i.end=function(a){return arguments.length?(d=a,i):d},i.granularity=function(a){if(!arguments.length)return e;if(g.indexOf(a)===-1)throw new Error("Granularity of "+a+" is not supported. Random Financial Data Generator only supports daily data.");return e=a,i},i.product=function(a){if(!arguments.length)return h;if("Data Generator"!==a)throw new Error("Random Financial Data Generator does not support products.");return h=a,i},i.apiKey=function(){throw new Error("Not implemented.")},i},Ha=function(){var b,c=1e3,d=e.feedGdax(),f=v(function(c){var e=a.time.second.offset(d.end(),-b*d.granularity());d.start(e),d(c)},c);return f.candles=function(a){return arguments.length?(b=a,f):b},f.apiKey=function(){throw new Error("Not implemented.")},a.rebind(f,d,"end","granularity","product"),f},Ia=function(a){var b;return a&&(b=a.message),b},Ja=function(){var b,c="BTC-USD",d=a.dispatch("open","close","error","message"),e="match",f=function(a,f){a=a||"wss://ws-feed.gdax.com",f=f||{type:"subscribe",product_id:c},b=new WebSocket(a),b.onopen=function(a){b.send(JSON.stringify(f)),d.open(a)},b.onerror=function(a){d.error(a)},b.onclose=function(a){d.close(a)},b.onmessage=function(a){var b=JSON.parse(a.data);b.type===e?d.message(b):"error"===b.type&&d.error(b)}};return a.rebind(f,d,"on"),f.close=function(){
// Only close the WebSocket if it is opening or open
!b||b.readyState!==WebSocket.CONNECTING&&b.readyState!==WebSocket.OPEN||b.close()},f.messageType=function(a){return arguments.length?(e=a,f):e},f.product=function(a){return arguments.length?(c=a,f):c},f},Ka=function(){function d(a){var b=k.get(a);return b||(b=a[0].toLowerCase()+a.substr(1)),b}function e(a){return a.map(function(a){return a.date.setHours(0,0,0,0),a})}function f(b){var c=a.time.second.offset(i.end(),-h*g);i.start(c).collapse(j.get(g)),i(function(a,c){if(a)b(a);else{var d=e(c);b(a,d)}})}var g,h,i=b.data.feed.quandl().database("WIKI").columnNameMap(d),j=a.map();j.set(86400,"daily"),j.set(604800,"weekly");
// Map fields for WIKI database, to use all adjusted values
var k=a.map();return k.set("Open","unadjustedOpen"),k.set("High","unadjustedHigh"),k.set("Low","unadjustedLow"),k.set("Close","unadjustedClose"),k.set("Volume","unadjustedVolume"),k.set("Adj. Open","open"),k.set("Adj. High","high"),k.set("Adj. Low","low"),k.set("Adj. Close","close"),k.set("Adj. Volume","volume"),f.candles=function(a){return arguments.length?(h=a,f):h},f.granularity=function(a){if(!arguments.length)return g;if(!j.has(a))throw new Error("Granularity of "+a+" is not supported.");return g=a,f},c.rebindAll(f,i,c.includeMap({end:"end",dataset:"product",apiKey:"apiKey"})),f},La=function(a){var b;return a&&a.quandl_error&&(b=a.quandl_error.message),b},Ma=function(){function b(a){return 0===a.getDay()||6===a.getDay()}var c=864e5,d=5*c,e=7*c,f={};
...
var g=a.time.saturday.ceil(b);if(c<g)return c.getTime()-b.getTime();var h=g.getTime()-b.getTime(),i=a.time.saturday.ceil(c),j=i.getTime()-c.getTime(),k=Math.round((i.getTime()-g.getTime())/e);return k*d+h-j},f.offset=function(c,e){var g=b(c)?f.clampUp(c):c,h=e;if(h<0){var i=a.time.monday.floor(g);if(h-=i.getTime()-g.getTime(),h>=0)return new Date(g.getTime()+e);g=a.time.day.offset(i,-2);var j=Math.floor(h/d);return g=a.time.day.offset(g,7*j),h-=j*d,g=new Date(g.getTime()+h),g=a.time.day.offset(g,2)}
...
if(h-=k.getTime()-g.getTime(),h<0)return new Date(g.getTime()+e);
// skip the weekend
g=a.time.day.offset(k,2);
// add all of the complete weeks to the date
var l=Math.floor(h/d);
// add the remaining time
return g=a.time.day.offset(g,7*l),h-=l*d,g=new Date(g.getTime()+h)},f.copy=function(){return f},f},Na=function(){function c(){return{week1:za.data.period("Weekly",604800,{unit:a.time.week,value:1},"%b %d"),day1:za.data.period("Daily",86400,{unit:a.time.day,value:1},"%b %d"),hour1:za.data.period("1 Hr",3600,{unit:a.time.hour,value:1},"%b %d %Hh"),minute5:za.data.period("5 Min",300,{unit:a.time.minute,value:5},"%H:%M"),minute1:za.data.period("1 Min",60,{unit:a.time.minute,value:1},"%H:%M")}}function d(){return{generated:za.data.source(Ga(),null,null,null,b.scale.discontinuity.identity()),bitcoin:za.data.source(Ha(),Ia,Ja(),ha,b.scale.discontinuity.identity()),quandl:za.data.source(Ka(),La,null,null,Ma())}}function e(){return{generated:za.data.product("Data Generator","Data Generator",[k.day1],l.generated,".3s"),quandl:za.data.product("GOOG","GOOG",[k.day1],l.quandl,".3s")}}function f(){var a=sa();a.id=x.uid();var c=za.menu.option("Candlestick","candlestick",a,"bf-icon-candlestick-series");c.isSelected=!0,c.option.extentAccessor=["high","low"];var d=b.series.ohlc();d.id=x.uid();var e=za.menu.option("OHLC","ohlc",d,"bf-icon-ohlc-series");e.option.extentAccessor=["high","low"];var f=b.series.line().xValue(function(a){return a.date});f.id=x.uid();var g=za.menu.option("Line","line",f,"bf-icon-line-series");g.option.extentAccessor="close";var h=b.series.point().xValue(function(a){return a.date});h.id=x.uid();var i=za.menu.option("Point","point",h,"bf-icon-point-series");i.option.extentAccessor="close";var j=b.series.area().xValue(function(a){return a.date});j.id=x.uid();var k=za.menu.option("Area","area",j,"bf-icon-area-series");k.option.extentAccessor="close";var l=za.menu.dropdownConfig(null,!1,!0,!0),m=[c,e,g,i,k];return za.menu.selector(l,m)}function g(){var a=Fa.secondary,c=b.series.line().decorate(function(a){a.enter().classed("movingAverage",!0)}).xValue(function(a){return a.date}).yValue(function(a){return a.movingAverage});c.id=x.uid();var d=za.menu.option("Moving Average","movingAverage",c,"bf-icon-moving-average-indicator",!0);d.option.extentAccessor=function(a){return a.movingAverage};var e=b.indicator.renderer.bollingerBands();e.id=x.uid();var f=za.menu.option("Bollinger Bands","bollinger",e,"bf-icon-bollinger-bands-indicator",!0);f.option.extentAccessor=[function(a){return a.bollingerBands.lower},function(a){return a.bollingerBands.upper}];var g=a.rsi();g.id=x.uid();var h=a.macd();h.id=x.uid();var i=a.volume();i.id=x.uid();var j=[d,f,za.menu.option("Relative Strength Index","rsi",g,"bf-icon-rsi-indicator",!1),za.menu.option("MACD","macd",h,"bf-icon-macd-indicator",!1),za.menu.option("Volume","volume",i,"bf-icon-bar-series",!1)];return j}function h(){var a=za.menu.dropdownConfig("Add Indicator",!1,!0);return za.menu.selector(a,g())}function i(){return{seriesSelector:f(),indicatorSelector:h()}}function j(){var a=za.chart.legend(m.generated,k.day1),b=za.chart.nav(m.generated.source.discontinuityProvider),c=za.chart.primary(m.generated,m.generated.source.discontinuityProvider),d=za.chart.secondary(m.generated,m.generated.source.discontinuityProvider),e=za.chart.xAxis(k.day1,m.generated.source.discontinuityProvider);return za.chart.group(a,b,c,d,e)}var k=c(),l=d(),m=e();return{data:[],periods:k,sources:l,selectors:i(),navReset:za.chart.navigationReset(),headMenu:za.menu.head([m.generated,m.quandl],m.generated,k.day1),overlay:za.menu.overlay([m.generated,m.quandl],m.generated),notificationMessages:za.notification.messages(),charts:j()}},Oa=function(b){a.json("https://api.gdax.com/products",function(a,c){return a?void b(a):void b(a,c)})},Pa=function(a,b,c,d){return a.map(function(a){return za.data.product(a.id,a.id,d.get(a.id)||c,b)})},Qa=function(){function d(){Z&&(Z=!1),ca&&J.suspendLayout(!1),J.chartsAndOverlay.datum(T.charts).call(V),J.app.select("#navbar-reset").datum(T.navReset).call(O),J.app.select(".head-menu").datum(T.headMenu).call(M),J.app.selectAll(".selectors").datum(T.selectors).call(P),J.app.select("#notifications").datum(T.notificationMessages).call(Q),J.overlay.datum(T.overlay).call(L),ca&&(J.suspendLayout(!0),ca=!1)}function e(){ca=!0,x.layout(J,V)}function f(){a.select(window).on("resize",function(){e(),_()})}function g(a){T.notificationMessages.messages.unshift(ba(a))}function h(a){var b=[a[0],a[1]];T.charts.primary.viewDomain=b,T.charts.secondary.viewDomain=b,T.charts.xAxis.viewDomain=b,T.charts.nav.viewDomain=b;var c=x.domain.filterDataInDateRange(b,T.data);T.charts.primary.visibleData=c,T.charts.secondary.visibleData=c;var d=x.domain.trackingLatestData(T.charts.primary.viewDomain,T.charts.primary.data);T.charts.primary.trackingLatest=d,T.charts.secondary.trackingLatest=d,T.charts.nav.trackingLatest=d,T.navReset.trackingLatest=d,_()}function i(a){a.isSelected=!a.isSelected,C(),_()}function k(a){a.isSelected=!a.isSelected,E(),_()}function l(a){T.charts.legend.data=a,_()}function m(a,b){var c;c=b.streamingNotificationFormatter?b.streamingNotificationFormatter(a):ha(a),c&&(g(c),_())}function n(){var a=T.charts.primary.data,c=b.util.extent().fields(["date"])(a),d=x.domain.moveToLatest(T.charts.primary.discontinuityProvider,c,c,Y);h(d)}function o(a,b){var c='<div class="spinner"></div>',d=arguments.length>1||a,e="";b&&b.length&&(e='<div class="content alert alert-info">'+b+"</div>"),J.app.select("#loading-status-message").classed("hidden",!d).html(b?e:c)}function p(a){T.data=a,T.charts.primary.data=a,T.charts.secondary.data=a,T.charts.nav.data=a}function q(a){var b=a.discontinuityProvider;T.charts.xAxis.discontinuityProvider=b,T.charts.nav.discontinuityProvider=b,T.charts.primary.discontinuityProvider=b,T.charts.secondary.discontinuityProvider=b}function r(a){T.headMenu.selectedProduct=a,T.overlay.selectedProduct=a,T.charts.primary.product=a,T.charts.secondary.product=a,T.charts.legend.product=a,q(a.source)}function s(a){T.headMenu.selectedPeriod=a,T.charts.xAxis.period=a,T.charts.legend.period=a}function t(a){o(!0),r(a),s(a.periods[0]),U(a.periods[0].seconds,a)}function u(){return N().on(j.crosshairChange,l).on(j.viewChange,h)}function v(){return X.navigationReset().on(j.resetToLatest,n)}function w(){return $().on(j.newTrade,function(a){if(p(a),T.charts.primary.trackingLatest){var c=x.domain.moveToLatest(T.charts.primary.discontinuityProvider,T.charts.primary.viewDomain,b.util.extent().fields(["date"])(T.charts.primary.data));h(c)}}).on(j.historicDataLoaded,function(a){o(!1),p(a),T.charts.legend.data=null,n(),e()}).on(j.historicFeedError,function(a,b){if(K){var c=K(a)||!0;o(!1,c)}else{o(!1,"Error loading data. Please make your selection again, or refresh the page.");var d="";try{var e=JSON.parse(a.responseText),f=b.historicNotificationFormatter(e);f&&(d=". "+f)}catch(h){d=""}var i=a.statusText||"Unknown reason.",j="Error getting historic data: "+i+d;g(j)}_()}).on(j.streamingFeedError,m).on(j.streamingFeedClose,m)}function y(){return X.head().on(j.dataProductChange,function(a){t(a.option),_()}).on(j.dataPeriodChange,function(a){o(!0),s(a.option),U(a.option.seconds),_()}).on(j.clearAllPrimaryChartIndicatorsAndSecondaryCharts,function(){T.charts.primary.indicators.forEach(A),T.charts.secondary.indicators.forEach(A),C(),E(),_()})}function z(a,b){b.forEach(function(a){a.isSelected=!1}),a.isSelected=!0}function A(a){a.isSelected=!1}function B(){return X.selectors().on(j.primaryChartSeriesChange,function(a){T.charts.primary.series=a,z(a,T.selectors.seriesSelector.options),_()}).on(j.primaryChartIndicatorChange,i).on(j.secondaryChartChange,k)}function C(){T.charts.primary.indicators=T.selectors.indicatorSelector.options.filter(function(a){return a.isSelected&&a.isPrimary}),T.overlay.primaryIndicators=T.charts.primary.indicators,T.headMenu.primaryIndicators=T.charts.primary.indicators}function D(){T.charts.secondary.indicators=T.selectors.indicatorSelector.options.filter(function(a){return a.isSelected&&!a.isPrimary}),V.secondaries().charts(T.charts.secondary.indicators.map(function(a){return a})),T.overlay.secondaryIndicators=T.charts.secondary.indicators,T.headMenu.secondaryIndicators=T.charts.secondary.indicators}function E(){D(),e()}function F(){return X.overlay().on(j.primaryChartIndicatorChange,i).on(j.secondaryChartChange,k).on(j.dataProductChange,function(a){t(a.option),_()})}function G(a){T.notificationMessages.messages=T.notificationMessages.messages.filter(function(b){return b.id!==a}),_()}function H(){return aa.toast().on(j.notificationClose,G)}function I(b,c){if(b){var d=b.statusText||"Unknown reason.",e="Error retrieving GDAX products: "+d;T.notificationMessages.messages.unshift(ba(e))}else{var f=[T.periods.hour1,T.periods.day1],g=a.map();g.set("BTC-USD",[T.periods.minute1,T.periods.minute5,T.periods.hour1,T.periods.day1]);var h=Pa(c,T.sources.bitcoin,f,g);T.headMenu.products=T.headMenu.products.concat(h),T.overlay.products=T.headMenu.products}_()}var J,K,L,M,O,P,Q,R='<div class="container-fluid">         <div id="notifications"></div>         <div id="loading-status-message"></div>         <div class="row head-menu head-row">             <div class="col-md-12 head-sub-row">                 <div id="product-dropdown" class="dropdown product-dropdown"></div>                 <div class="selectors">                     <div class="series-dropdown dropdown selector-dropdown"></div>                     <div class="indicator-dropdown dropdown selector-dropdown"></div>                     <div id="mobile-period-selector" class="dropdown"></div>                 </div>                 <div id="period-selector"></div>                 <span id="clear-indicators" class="icon bf-icon-delete delete-button"></span>             </div>         </div>         <div class="row primary-row">             <div id="charts" class="col-md-12">                 <div id="charts-container">                     <svg id="primary-container"></svg>                     <div id="secondaries-container"></div>                     <div class="x-axis-row">                         <svg id="x-axis-container"></svg>                     </div>                     <div id="navbar-row">                         <svg id="navbar-container"></svg>                         <svg id="navbar-reset"></svg>                     </div>                 </div>                 <div id="overlay">                     <div id="overlay-primary-container">                         <div id="overlay-primary-head">                             <div class="selectors">                                 <div id="mobile-product-dropdown" class="dropdown"></div>                                 <div class="series-dropdown dropdown selector-dropdown"></div>                                 <div class="indicator-dropdown dropdown selector-dropdown"></div>                             </div>                             <div id="legend">                                 <svg id="tooltip"></svg>                             </div>                         </div>                         <div id="overlay-primary-bottom">                             <div class="edit-indicator-container"></div>                         </div>                     </div>                     <div id="overlay-secondaries-container"></div>                     <div class="x-axis-row"></div>                     <div id="overlay-navbar-row"></div>                 </div>             </div>         </div>     </div>',S={},T=Na(),U=w(),V=u(),W=!1,Y=.2,Z=!0,_=b.util.render(d),ca=!0;return S.fetchGdaxProducts=function(a){return arguments.length?(W=a,S):W},S.changeQuandlProduct=function(a){var b=fa.product(a,a,[T.periods.day1],T.sources.quandl,".3s"),c=T.headMenu.products.some(function(a){return a.id===b.id}),d=T.overlay.products.some(function(a){return a.id===b.id});c||T.headMenu.products.push(b),d||T.overlay.products.push(b),t(b),Z||_()},S.proportionOfDataToDisplayByDefault=function(a){return arguments.length?(Y=a,S):Y},S.historicFeedErrorCallback=function(a){return arguments.length?(K=a,S):K},S.indicators=function(a){if(!arguments.length){var b=[];return T.selectors.indicatorSelector.options.forEach(function(a){a.isSelected&&b.push(a.valueString)}),b}return T.selectors.indicatorSelector.options.forEach(function(b){b.isSelected=a.some(function(a){return a===b.valueString})}),C(),Z?D():(E(),_()),S},S.run=function(b){if(!b)throw new Error("An element must be specified when running the application.");var c=a.select(b);c.html(R);var d=c.select("#charts"),g=c.select("#charts-container"),h=c.select("#overlay");J={app:c,charts:g,chartsAndOverlay:d,primary:g.select("#primary-container"),secondaries:g.select("#secondaries-container"),xAxis:g.select("#x-axis-container"),navbar:g.select("#navbar-container"),overlay:h,overlaySecondaries:h.select("#overlay-secondaries-container"),legend:c.select("#legend"),suspendLayout:function(a){var b=this;Object.keys(b).forEach(function(c){"function"!=typeof b[c]&&b[c].layoutSuspended(a)})}},M=y(),O=v(),P=B(),L=F(),Q=H(),e(),f(),U(T.headMenu.selectedPeriod.seconds,T.headMenu.selectedProduct),W?Oa(I):T.sources.bitcoin&&delete T.sources.bitcoin},c.rebindAll(S,T.sources.quandl.historicFeed,c.includeMap({apiKey:"quandlApiKey"})),c.rebindAll(S,U,c.includeMap({candlesOfData:"periodsOfDataToFetch"})),S},Ra={app:Qa},Sa=window.location.search.split("seed=")[1];Sa&&Math.seedrandom(Sa),Ra.app().fetchGdaxProducts(!0).run("#app-container")});